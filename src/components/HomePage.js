...
import main from '../assest/maimt.jpg'
...
export function HomePage() {
  return (
    <>
      <Header/>
      <Navbarpage  />
      <Container fluid style={{ margin: '0', padding: '0', overflow: 'hidden', textAlign: 'center' }}>
        <Row>
          <Col className='main-page' style={{ fontSize: '4rem', color: 'white' }}>
            <p style={{ color: 'rgba(3,155,227,255)', fontSize: '4rem', position: 'relative', textAlign: 'center', top: '2rem' }}>Welcome To</p>
            <p >
              <span style={{ color: 'yellow', top: '4rem' }}> Maharaja</span>
              Agrasen Institute </p>
            <p style={{ fontSize: '2rem' }}>of</p>
            <h1>Management and Technology</h1>
            <p style={{ color: 'rgba(80,204,218,255)' }}>Digital Library</p>
          </Col>
        </Row>
      </Container>
      <Container>
